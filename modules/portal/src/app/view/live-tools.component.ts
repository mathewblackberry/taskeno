  ...
  template: `
    <div class="d-flex align-items-start v-tabs-panel">
      <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
        <button class="nav-link" id="v-pills-radius-tab" data-bs-toggle="pill" data-bs-target="#v-pills-radius" type="button role=tab" aria-controls="v-pills-radius" aria-selected="false">Chart</button>
        ...
        <button class="nav-link active" id="v-pills-action-tab" data-bs-toggle="pill" data-bs-target="#v-pills-action" type="button role=tab" aria-controls="v-pills-action" aria-selected="true">Router Commands</button>
      </div>
      <div class="tab-content" id="v_pills-tabContent">
        <div class="tab-pane fade" id="v-pills-radius" role="tabpanel" aria-labelledby="v-pills-radius-tab">
          <app-chart></app-chart>
        </div>
        ...
        <div class="tab-pane fade show active" id="v-pills-action" role="tabpanel" aria-labelledby="v-pills-addresses-tab">
          <div class="tile-wrapper">
            <app-tile buttonText="Update Certificate" [action]="updateCert"/>
            <app-tile buttonText="Make Router Active" *ngIf="!asset.active" [action]="activateRouter"/>
            <app-tile buttonText="Make Router Inctive" *ngIf="asset.active" [action]="deactivateRouter"/>
...
export class LiveToolsComponent implements OnChanges {
  ...
  activateRouter = () => {
    this.siteAssetService.activateRouter(this.site.id, this.asset.id).subscribe(response => {
      // if (response.data) {
  ...
  deactivateRouter = () => {
    this.siteAssetService.deactivateRouter(this.site.id, this.asset.id).subscribe(response => {
      // if (response.data) {
